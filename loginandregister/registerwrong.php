...
<p>OEI. Iets ging fout!           Let er goed op dat je datum moet invullen als jaar-maand-dag.</p>
<p>Als de datum klopt heb je een gebruikersnaam gebruikt die wellicht al bestaat.</p>
<form method="post" action="register.php" enctype="multipart/form-data">
  ...
  <p>Geboortedatum moet in volgorde van jaar-maand-dag</p>
